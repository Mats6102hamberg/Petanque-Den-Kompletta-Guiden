...
const flagshipProducts: ProductCard[] = [
  ...
  },
  {
    icon: "⚡",
    title: "FakturaSnap",
    tagline: "Smart fakturering med AI",
    description:
      "Skapa fakturor på sekunder, skanna kvitton och låt AI fixa moms, export och påminnelser.",
    features: [
      "AI-driven kvittoskanning",
      "Automatisk momsberäkning",
      "SIE-export till revisor",
      "7 länder (SE, UK, DE, NL, FI, NO, DK)",
    ],
    ctaLabel: "Prova gratis",
    ctaHref: "https://fakturasnap.se",
    variant: "primary",
  },
  {
    icon: "🤖",
    title: "Boris Suite",
    tagline: "Din digitala bokföringsassistent",
    description:
      "Boris är AI-assistenten som hjälper dig med skatt, moms och bokföringsregler – på ditt språk.",
    features: [
      "Skatt-O-Meter i realtid",
      "Prospero-prognoser",
      "Avtalsscanner och kvittologg",
      "Lokaliserad för varje land",
    ],
    ctaLabel: "Läs mer",
    ctaHref: "#kontakt",
    variant: "outline",
